/*  Write C# program to create structure called Book with title, author, publisher, and price as the fields of information. 
Create 2 books with this structure and print the details of these books.  */
