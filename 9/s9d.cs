...
// + operator to add 2 objects
// -- operator to decrement the value of an object.
...
class OverloadTest
{
    static void Main(string[] args)
    {
        ...
        Box Box2 = new Box(12, 13, 10);   // Declare Box2 of type Box
        ...
        Box3 = --Box3;
        volume = Box3.getVolume();
        Console.WriteLine("Volume of Box3 after decrement (-- Overload): {0}", volume);
    }
}
